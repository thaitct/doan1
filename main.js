...
function handleAddSv(event) {
    ...
    const arrayInputs = [tenSvElement, emailSvElement, courseSvElement, diemToanSvElement, diemHoaSvElement, diemLySvElement]
    ...
    if (editId) {
        ...
        editElement.diemHoa = diemHoaSvElement.value;
        editElement.diemLy = diemLySvElement.value;
        editElement.diemToan = diemToanSvElement.value;
